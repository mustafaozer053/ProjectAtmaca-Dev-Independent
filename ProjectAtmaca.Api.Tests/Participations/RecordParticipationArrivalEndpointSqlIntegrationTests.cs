...
public sealed class
    RecordParticipationArrivalEndpointSqlIntegrationTests
{
    private const string TestAuthenticationScheme =
        "RecordParticipationArrivalSqlIntegration";

    internal const string ExternalSubject =
        "record-participation-arrival-sql-subject";
    ...
    public async Task Post_Should_PersistThroughCanonicalProductionSecurityAndAuditPipeline()
    {
        ...
        string databaseName =
            $"ProjectAtmaca_Api_RecordArrival_{Guid.NewGuid():N}";
                    ...
                    services =>
                    {
                        ...
                        services
                            ...
                            .AddScheme<
                                ...
                                RecordParticipationArrivalSqlTestAuthenticationHandler>(
                                TestAuthenticationScheme,
                                _ =>
                                {
                                });
...
{
    public RecordParticipationArrivalSqlTestAuthenticationHandler(
