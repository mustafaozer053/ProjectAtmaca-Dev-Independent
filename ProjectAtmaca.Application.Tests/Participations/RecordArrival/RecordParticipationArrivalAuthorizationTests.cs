...
public sealed class RecordParticipationArrivalAuthorizationTests
{
    [Fact]
    public async Task Handle_Should_ReturnForbiddenWithoutPersistenceAccess_WhenActorLacksRecordArrivalPermission()
    {
